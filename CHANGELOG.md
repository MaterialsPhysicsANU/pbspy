...
## [Unreleased](https://github.com/MaterialsPhysicsANU/pbspy/compare/v0.1.0...HEAD)

## [0.1.0](https://github.com/MaterialsPhysicsANU/pbspy/releases/tag/v0.1.0) - 2026-07-30
...
- Add `output_path` and `error_path` to `JobDescription`
